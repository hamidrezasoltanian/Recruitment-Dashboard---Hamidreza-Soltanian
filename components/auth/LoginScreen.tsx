...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden" style={{background: 'linear-gradient(135deg, var(--color-primary-700) 0%, var(--color-primary-900) 100%)'}}>
      ...
      <div className="absolute top-1/2 left-[-40px] w-32 h-32 rounded-full opacity-10" style={{background: 'var(--color-primary-200)'}}></div>
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 text-sm font-bold text-white rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary-500)]"
